...
int main() 
{
    ...
    if (filechoice == 1 )
    {
       ...
       PhoneEntry *n = new PhoneEntry[howmany];
        ...
        for( int i = 0 ; i < howmany ; i ++ )
        {
            ...
            cout<<" Enter the information for person # "<<i+1<<"."<<endl;
            cout<<"First name: ";
            cin>>n[i].firstn;
            cout<<endl;
            cout<<"Last name : " ;
    ...
    else if ( filechoice == 2)
    {
        ...
        //infile.open("/Users/tjmoore/Documents/School/Broward/C++/Intermediate C++/Practice/Exercie 18 String/Exercie 18/list.txt");
       ...
       infile.open(fileName.c_str());
        ...
        // if it is found it will display
        // all the names that include whatever the user entered
