    ...
    public static void main(String args[])
    {
        double total  = 0.0, average = 0.0;
         ...
         System.out.print("Country: "+NewBottle.getname()+"\nPopulation: "+ 
                 ...
                 NewBottle.getlength()+"inches \nVolume of an average Bottle: "+ 
                 NewBottle.getvolume() +" ounces per bottle.");
         
         
         
         System.out.println("\n\nThe total number of bottles consumed in the "+ 
                 NewBottle.getname()
                 +" are: "+ total+ " bottles.");
         ...
         System.out.println("The average amount of water consumed per person is: "+ 
               average + " gallons." );
                 ...
                 NewBottle.setlength(9.5);
                 NewBottle.setvolume(16);
